%% MÉTODO DE EULER MODIFICADO O DE EULER-CAUCHY
%---------------------------------------------------------
function [x,y]=cauchysis(f,a,b,y0,n)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Aproxima la solución de un PVI para un sistema de EDOs
% usando el método de Euler Modificado o de Euler-Cauchy
...
y(i+1,:)=y(i,:)+h*f(x(i)+l,y(i,:)+l*f(x(i),y(i))')'; %Método de Cauchy.
end